...
The Let's Mix Shortcode plugin allows you to integrate a player widget with tracklist from Let's Mix into your Wordpress Blog by using a Wordpress shortcode.
